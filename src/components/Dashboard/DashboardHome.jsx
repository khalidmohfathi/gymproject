    ...
    <section className="vh-100">
      <div className="container-fluid h-100">
        <div className="row h-100">
          <div className="col-lg-9 d-flex flex-column gap-4 px-4 py-3 bg-grey text-white">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="d-flex align-items-center gap-4">
                ...
                <div
                  ...
                  className="rounded-circle border border-2 border-danger d-flex justify-content-center align-items-center"
                >
            ...
            <div className="row g-4">
              <div className="col-md-4">
                <div className="bg-primary p-3 rounded-3 h-100 d-flex flex-column justify-content-between">
                  <p className="m-0">
              ...
              <div className="col-md-4">
                <div className="bg-success p-3 rounded-3 h-100 d-flex flex-column justify-content-between">
                  <p>
              ...
              <div className="col-md-6">
                <div className="bg-white p-3 rounded-3 text-black h-100">
              ...
              <div className="col-md-6">
                ...
                <div className="bg-white p-3 rounded-3 text-black">
                  <div className="p-2.5 bg-secondary-subtle rounded-2 d-flex justify-content-between align-items-center fw-medium">
                      ...
                      <div className="d-flex align-items-center gap-5">
                        <div className="d-flex align-items-center gap-1">
                          <div
                            ...
                            className="rounded-circle"
                          ></div>
                          <span style={{fontSize:12}} className="text-muted">8% Carbs</span>
                        </div>
                        <div className="d-flex align-items-center gap-1">
                          <div
                            style={{
                            ...
                            className="rounded-circle"
                          ></div>
                          <span style={{fontSize:12}} className="text-muted">16% Protien</span>
                        </div>
                        <div className="d-flex align-items-center gap-1">
                          <div
                            style={{
                            ...
                            className="rounded-circle"
                          ></div>
                          <span style={{fontSize:12}} className="text-muted">6% Fats</span>
                        </div>
                      </div>
          ...
          <div className="col-lg-3 bg-secondary-subtle px-4 py-3 d-flex flex-column gap-3">
            <div className="d-flex align-items-center gap-2.5">
              <div style={{ width: "60px", height: "60px" }}>
                <img
                  src="https://placehold.co/60/red/white"
            ...
            <div className="bg-white px-4 py-3 rounded-4 text-center d-flex justify-content-between">
              <div>
                <div className="d-flex align-items-baseline">
                  <span className="fs-4 fw-semibold">70</span>
                  <span className="text-secondary">kg</span>
                </div>
                <p className="mb-0 text-muted">Weight</p>
              </div>
              <div>
              ...
              <div>
                <div className="d-flex align-items-baseline">
                  ...
                  <span className="text-secondary">yrs</span>
                </div>
            ...
            <div>
              ...
              <div className="d-flex flex-column gap-3">
                <div className="bg-white p-2.5 rounded-4 d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div>
                      ...
                      <p style={{fontSize:14}} className="mb-0 text-secondary">70km/80km</p>
                    </div>
                  </div>
                ...
                <div className="bg-white p-2.5 rounded-4 d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div>
                      ...
                      <p style={{fontSize:14}} className="mb-0 text-secondary">50hrs/60hrs</p>
                    </div>
                  </div>
                  <div style={{ width: 50, height: 50 }}>
                    <CircularProgressbar
                ...
                <div className="bg-white p-2.5 rounded-4 d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div>
                      ...
                      <p style={{fontSize:14}} className="mb-0 text-secondary">70km/100km</p>
                    </div>
                  </div>
                  <div style={{ width: 50, height: 50 }}>
                    <CircularProgressbar
            ...
            <div>
              ...
              <div className="bg-white rounded-4 pb-3">
                ...
                />
                <p className="mb-0 text-center fw-light text-muted">
                  You have achieved <span className="text-danger fw-normal">40%</span> of
                  your <br /> goal this month
                </p>
              </div>
            </div>
          </div>
